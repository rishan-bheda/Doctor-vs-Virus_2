var marketImg, virus, virusImg, doctor, doctorImg, npc1, npc2, npc3, npc4, npc5, npc6, manImg1, manImg2, womanImg1, womanImg2;
...
function setup() {
    ...
    npc1 = createSprite(random(550,1000),random(230,750),50,50);
    npc2 = createSprite(random(550,1000),random(230,750),50,50);
    npc3 = createSprite(random(550,1000),random(230,750),50,50);
    npc4 = createSprite(random(550,1000),random(230,750),50,50);
    npc5 = createSprite(random(550,1000),random(230,750),50,50);
    npc6 = createSprite(random(550,1000),random(230,750),50,50);
